...
* :books: **Содержание**
	* Операторы. Переменные. Типы данных. Условия
		...
		* Строки
		* [Задачи по материалам недели](https://github.com/pilyay/python-programming-course-by-bioinformatics-institute/blob/master/python-programming.ipynb#2.1-%D0%A6%D0%B8%D0%BA%D0%BB-while)
	* Циклы. Строки. Списки
		* Цикл while
