...
* :file_cabinet: **Содержание**
	* :open_file_folder: [Теория]()
	* :open_file_folder: [Практика](https://github.com/pilyay/python-programming-course-by-bioinformatics-institute/blob/master/python-programming.ipynb)
